ShopifyApp.configure do |config|
  ...
  config.api_key = ENV.fetch('SHOPIFY_API_KEY', '840dda720d85df6998dc860207d63806').presence
  config.secret = ENV.fetch('SHOPIFY_API_SECRET', '88bf5602a907ff0d5d255677d43c16eb').presence
...
Rails.application.config.after_initialize do
  if ShopifyApp.configuration.api_key.present? && ShopifyApp.configuration.secret.present?
    ShopifyAPI::Context.setup(
      ...
      host_name: URI(ENV.fetch('HOST', 'https://2d17-119-73-121-153.in.ngrok.io')).host || '',
